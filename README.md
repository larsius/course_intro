...
## Credits
first part (1.-7.) is is modified from (https://github.com/jerry-git/learn-python3)

pandas intro modified from Joris van den Bossche
recommended further notebooks here:
